...
if submitted and user_question:
    ...
    if needs_urgent_escalation(user_question):
        st.error("This may be a medical emergency. Please call 911 or seek immediate help.")
    else:
        answer = result['answer']
        if is_sensitive_topic(user_question):
    ...
    for doc in result['context']:
        question = doc.metadata.get('question') if hasattr(doc, 'metadata') and doc.metadata else None
